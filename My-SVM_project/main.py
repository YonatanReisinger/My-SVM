...
def question1():
    ...
    question1_quadratic(feature_matrix_train, feature_matrix_test, true_labels_train, true_labels_test)
    question1_dualic(feature_matrix_train, feature_matrix_test, true_labels_train, true_labels_test)

def question1_quadratic(feature_matrix_train, feature_matrix_test, true_labels_train, true_labels_test):
...
def question1_dualic(feature_matrix_train, feature_matrix_test, true_labels_train, true_labels_test):
    clf = SVM(optimization_form="dual")
    clf.fit(feature_matrix_train, true_labels_train)
